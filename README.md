[![Docker Build](https://img.shields.io/docker/automated/justb4/jmeter.svg)](https://hub.docker.com/r/kiranraju88/jmeter_aws-ec2)
...
of the pre-built Images from [Docker Hub](https://hub.docker.com/r/kiranraju88/jmeter).
...
1. In a Terminal/Command session, install Git, navigate/make a folder, then:
   ...
   ```
   git clone git@github.com:kiranraju88/docker.git
   cd docker
   ```
